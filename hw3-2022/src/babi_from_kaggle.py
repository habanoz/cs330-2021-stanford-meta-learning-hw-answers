...
ZIP_URL = "https://storage.googleapis.com/kaggle-data-sets/657043/1160690/bundle/archive.zip?X-Goog-Algorithm=GOOG4-RSA-SHA256&X-Goog-Credential=gcp-kaggle-com%40kaggle-161607.iam.gserviceaccount.com%2F20230426%2Fauto%2Fstorage%2Fgoog4_request&X-Goog-Date=20230426T125244Z&X-Goog-Expires=259200&X-Goog-SignedHeaders=host&X-Goog-Signature="
ZIP_URL = "/home/melek/Downloads/archive/archive.tar.gz"
paths = {
    "en": {
        "qa9": {
...
if __name__ == '__main__':
    name='en-valid-10k-qa1'
    babi  = BabiQa(config_name=name)
    babi.download_and_prepare(output_dir=name)
    ds = babi.as_dataset()
    login(token="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")
    ds.push_to_hub(f"habanoz/babi_qa_{name.replace('-','_')}")