...
\begin{enumerate}
    ...
    Answer: According to chart below, zero-shot performance matters significantly with scale. However, few-shot performance does not vary much with scale.

    \includegraphics{images/q1}
    ...
    Answer: TLDR performs better than none which is expected. Custom prompt is not used.

    \includegraphics{images/q2}
