...
class EncoderDecoder(Embedder, relabel.RewardLabeler):
    ...
    def _compute_losses(
        ...
        # ********************************************************
        decoder_context_loss = (decoder_context_loss * mask).sum() / mask.sum()
    ...
    def label_rewards(self, trajectories):
        ...
        # already done for you below, and you don't need to do anything.
        ...
        batch_size, episode_length_1 = mask.shape
        assert log_q_omega.shape == (batch_size, episode_length_1)
        assert rewards.shape == (batch_size, episode_length_1 - 1)
